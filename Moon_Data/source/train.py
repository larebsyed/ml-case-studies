...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=1000, metavar='ID',
                        help='input layers (default: 1000)')
    parser.add_argument('--hidden_dim', type=int, default=500, metavar='HD',
                        help='hidden layers (default: 500)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OD',
                        help='output layers (default: 1)')
